...
const AuthNavigator  = () => (
    <NavigationContainer>
        <Stack.Navigator initialRouteName="NewListingScreen" screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name='ProfileScreen' component={ProfileScreen} initialParams={{ user: 'q' }}/>
        </Stack.Navigator>
    </NavigationContainer>
