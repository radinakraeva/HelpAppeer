...
//         listingInfo.location = {lat1: latitude, lon1: longitude};
//     };
//
//     useEffect(() => {
//         getLocation();
...
//         };
//
//         console.log("TEST"+submission.user)
//         console.log(submission.listing);
//
//
...
//         if (isEmpty(photo1)) {
//             setPhoto1({uri: u});
//             listingInfo.photo1 = {uri: u}
//         } else if (isEmpty(photo2)) {
//             setPhoto2({uri: u});
//             listingInfo.photo2 = {uri: u}
//         } else if (isEmpty(photo3)) {
//             setPhoto3({uri: u});
//             listingInfo.photo3 = {uri: u}
//         } else {
...
//             <InputField placeholder="Listing's title" onChange={text => updateTextField('title',text)}/>
//
//             <Text style={styles.subtitle}>Category</Text>
//             {getCategories()}
//
//             <Text style={styles.subtitle}>Description</Text>
//             <InputField size={150} placeholder="Description" onChange={text => updateTextField('desc',text)}/>
//
...
//             </View>
//
//             <InputField placeholder="Additional information (e.g. apt number)" onChange={text => updateTextField('addInfo',text)}/>
//
//
